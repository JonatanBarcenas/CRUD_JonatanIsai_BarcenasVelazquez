...
namespace Passengers.Web.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        private async Task<String> CreateJwtTokenAsync(IdentityUser user)
        {
            ...
            {
                new Claim(Microsoft.IdentityModel.JsonWebTokens.JwtRegisteredClaimNames.Iss, _jwtOptions.Issuer),
            ...
            foreach(var roleName in roleNames)
            {
                ...
                if (role != null)
                {
                    var roleClaim = new Claim(ClaimTypes.Role, roleName, ClaimValueTypes.String, _jwtOptions.Issuer);
